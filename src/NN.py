...
# class NeuralNetwork:
#     def __init__(self, data_path, plot_dir='./plot/NN'):
...
from sklearn.metrics import confusion_matrix, roc_curve, auc, precision_score, recall_score, f1_score
from sklearn.model_selection import train_test_split
from preprocessing import Preprocessing  # Import the Preprocessing class
...
class NeuralNetwork:
    ...
    def load_and_preprocess_data(self):
        # Initialize Preprocessing class and load data
        preprocessor = Preprocessing(self.data_path, self.processed_data_path)
        preprocessor.load_data(sample_fracs={0: 0.01, 1: 0.01, 2: 0.01, 3: 0.01})  # Adjust sample_fracs as needed
        preprocessor.preprocess_data(apply_pca=False)  # Adjust apply_pca and n_components as needed
