...
plt.rcParams.update({
    ...
    'legend.fontsize': 18   # Legend font sizespl
})
...
class Preprocessing:
    ...
    def load_data(self, sample_fracs, random_state=42):
        ...
        print(f"\n After ballance {df_sample_balanced['source'].value_counts()}")
    ...
    def preprocess_data(self, apply_pca=False, n_components=5, degree=2):
        ...
        X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.20, random_state=42, stratify=None) # stratify=y
