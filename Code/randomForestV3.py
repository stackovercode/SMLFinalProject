...
# No need to fit again, grid_search.fit already does that

# # Use the best hyperparameters from the previous grid search (if you want to use saved best params directly)
#best_params = {'max_depth': 20, 'min_samples_leaf': 5, 'min_samples_split': 20, 'n_estimators': 150}
#best_params = {'max_depth': 10, 'min_samples_leaf': 10, 'min_samples_split': 30, 'n_estimators': 100}
#best_params = {'max_depth': 5, 'min_samples_leaf': 15, 'min_samples_split': 35, 'n_estimators': 75}
#best_params = {'max_depth': 3, 'min_samples_leaf': 20, 'min_samples_split': 50, 'n_estimators': 150}
#best_params = {'max_depth': 5, 'min_samples_leaf': 10, 'min_samples_split': 25, 'n_estimators': 200}
