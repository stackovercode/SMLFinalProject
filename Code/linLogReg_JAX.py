...
# Load dataset
data = './cleaned_robot_data.csv'
df = pd.read_csv(data, header=1)

# Define directory for saving plots
plot_dir = './TestingPlots/linLogReg_JAX'
...
# Inspect initial rows and data types
print(df.head())
print(df.info())

# Assign column names and drop the original header row if it exists
